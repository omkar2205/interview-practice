(function () {
  async function robustCallApi(action, payload = {}) {
    ...
    try {
      ...
      throw new Error('Could not reach the Apps Script backend. Open the /exec URL directly and confirm it shows version 2.0-dynamic. In Apps Script, set Execute as: Me and Who has access: Anyone, then deploy a new version.');
    }
  }
